import HautevilleHouse.MedicineOutbreakInvestigationLemmaCanonicalLaneLean.ReviewerBridge
...
def sourceTheoremStatement : TheoremStatement := {
  ...
  constrainedStatement := "constrained outbreak theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
